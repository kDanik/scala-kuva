...
/**
 * Used for comparison of two floats, with specified precision. This is useful to check if 2
 * floats are equal to each other, ignoring imprecise way floating point arithmetic is performed
 */
implicit class FloatWithAlmostEquals(private val f1: Float) extends AnyVal {
  @targetName("~=")
